...
export const ConnectionButtons = ({
  ...
  return (
    <div className={styles.wrapper}>
      <Button className={styles.connectButton} onClick={onConnect} disabled={connectDisabled}>
        {connectText}
      </Button>
      <Button className={styles.disconnectButton} onClick={onDisconnect} disabled={!connectDisabled}>
        {disconnectText}
      </Button>
    </div>
  );
